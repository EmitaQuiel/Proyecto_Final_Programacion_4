    ...
    public partial class FormClientes : Form
    {
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (idgenerado != 0)
            {
                ...
                dgvdata.Rows.Add(new object[] {"",idgenerado,txt_Documento.Text,txt_NombreCompleto.Text,txt_Correo.Text,txt_Telefono.Text,
        ...
        private void dgvdata_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                var w = Properties.Resources.DataGridView_Check.Width;
                var h = Properties.Resources.DataGridView_Check.Height;
